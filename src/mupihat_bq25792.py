...
class bq25792:
    ...
    class REG1C_Charger_Status_1(BQ25795_REGISTER):
        ...
        def get_VBUS_STAT_string(self):
            ...
            elif self.VBUS_STAT == 0x9 or self.VBUS_STAT == 0xA:
                return "Reserved"
            elif self.VBUS_STAT == 0xB:
                return "Device directly powered from VBUS"
            elif (
                self.VBUS_STAT == 0xC
                or self.VBUS_STAT == 0xD
                or self.VBUS_STAT == 0xE
                or self.VBUS_STAT == 0xF
            ):
                return "Reserved"
            else:
                return "Reserved"
    ...
    class REG48_Part_Information(BQ25795_REGISTER):
        ...
        def get_PART_NUMBER_string(self):
            ...
            if self.PART_NUMBER == 1:
                ...
                self.PART_NUMBER == 0
                or self.PART_NUMBER == 2
                or self.PART_NUMBER == 3
                or self.PART_NUMBER == 4
                or self.PART_NUMBER == 5
                or self.PART_NUMBER == 6
                or self.PART_NUMBER == 7
            ):
                return "Reserved"
            else:
                return "unknown"
        ...
        def get_PART_REVISION_string(self):
            ...
            if self.PART_REVISION == 0:
                ...
                or self.PART_REVISION == 2
                or self.PART_REVISION == 3
                or self.PART_REVISION == 4
                or self.PART_REVISION == 5
                or self.PART_REVISION == 6
                or self.PART_REVISION == 7
            ):
                return "Reserved"
            else:
                return "unknown"
